...
This result does not match what I expected. I expected to find the sensors with the addresses 0x52 (ToF) and 0x69 (IMU), however it says that every I2C address is detected for the ToF above and no device is detected for the IMU below. 
